...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Widget build(BuildContext context) {
    List<QuizModel> quizes = context.read<QuizProvider>().quizes;
      ...
      return Scaffold(
        body: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              UserQuizModel? userQuiz = userQuizModel(context, quizes[index]);
                    ...
                    onTap: () {
                      if (enrolled) {
                        if (userQuiz?.attemped == false) {
                          ...
                          Get.to(() => QuizResultScreen(userQuiz: userQuiz!));
                        }
                      } else {
