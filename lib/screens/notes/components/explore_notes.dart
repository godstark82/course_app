                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      ...
                      child: Text((index + 1).toString()).text.white.make(),
                    ),
                    ...
                    onTap: () {
                      if (isPurchased) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text('Please purchase to unlock this')));
                      }
                    },
                    title: notes.pdfs[index].name.toString().text.make(),
                    subtitle: 'Click to view'.text.make(),
